...
| Documentation | Applies: this README, `DESIGN.md` with the architecture and an acceptance record, `CHANGELOG.md`, `CONTRIBUTING.md`, `SECURITY.md`, `CITATION.cff`, `CODEOWNERS`, `docs/first-real-target.md`, `docs/recordings-data-card.md`, `docs/feature-expansion-ideas.md`, `docs/model-card-judge.md`, `docs/responsible-tech.md`, and an ADR log at `docs/adr/` — four entries, `0000` through `0003`. Not met: the quickstart sits well below the top of this file |
